export const buildingTypeGroups = [
  { label: 'سكني', options: [['apartment','شقة'],['villa','فيلا'],['residential_building','مبنى سكني متعدد الوحدات'],['residential_compound','مجمع سكني'],['worker_housing','سكن عمال'],['residential_annex','استراحة أو ملحق سكني']] },
  { label: 'تجاري وإداري', options: [['shop','محل تجاري'],['showroom','معرض'],['office','مكتب'],['administrative_building','مبنى إداري'],['restaurant','مطعم'],['cafe','مقهى']] },
